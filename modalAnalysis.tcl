...
# --------------------------------------
proc modalAnalysis {numModes {pflag 0} {tag ""} {rdamp {0}} {xi 0.05}} {
...
file delete "Periods${tag}.txt"
set period "Periods${tag}.txt"
...
file delete "eigenVectors${tag}.txt"
print "eigenVectors${tag}.txt" -node
